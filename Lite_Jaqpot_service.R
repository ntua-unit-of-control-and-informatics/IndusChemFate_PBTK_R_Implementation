...
create.params <- function(user_input) {
  with(as.list(user_input),{
    ...
    mw_2 <- NULL # molecular weight
    vpPa_2 <- NULL # vapour pressure in Pascal
    lkow_2 <- NULL # log(Kow) in blood at pH 7.4
    wsol_2 <- NULL # water solubility in mg/litres
    dens_2 <- NULL # density in mg/cm3 or g/litre needed for dermal absorption
    
    # Third metabolite (index 3)
    mw_3 <- NULL # molecular weight
    vpPa_3 <- NULL # vapour pressure in Pascal
    lkow_3 <- NULL # log(Kow) in blood at pH 7.4
    wsol_3 <- NULL # water solubility in mg/litres
    dens_3 <- NULL # density in mg/cm3 or g/litre needed for dermal absorption
    
    # Fourth metabolite (index 4)
    mw_4 <- NULL # molecular weight
    vpPa_4 <- NULL # vapour pressure in Pascal
    lkow_4 <- NULL # log(Kow) in blood at pH 7.4
    wsol_4 <- NULL # water solubility in mg/litres
    dens_4 <- NULL # density in mg/cm3 or g/litre needed for dermal absorption
    
    params$Vmax_Adip_0 = 0; params$Vmax_Adip_1 = 0; params$Vmax_Adip_2 = 0; params$Vmax_Adip_3 = 0; params$Vmax_Adip_4 = 0;
    params$Vmax_Bone_0 = 0; params$Vmax_Bone_1 = 0; params$Vmax_Bone_2 = 0; params$Vmax_Bone_3 = 0; params$Vmax_Bone_4 = 0;
    params$Vmax_Brain_0 = 0; params$Vmax_Brain_1 = 0; params$Vmax_Brain_2 = 0; params$Vmax_Brain_3 = 0; params$Vmax_Brain_4 = 0;
    params$Vmax_Heart_0 = 0; params$Vmax_Heart_1 = 0; params$Vmax_Heart_2 = 0; params$Vmax_Heart_3 = 0; params$Vmax_Heart_4 = 0;
    params$Vmax_Kidney_0 = 0; params$Vmax_Kidney_1 = 0; params$Vmax_Kidney_2 = 0; params$Vmax_Kidney_3 = 0; params$Vmax_Kidney_4 = 0;
    params$Vmax_Intestine_0 = 0; params$Vmax_Intestine_1 = 0; params$Vmax_Intestine_2 = 0; params$Vmax_Intestine_3 = 0; params$Vmax_Intestine_4 = 0;
    params$Vmax_Liver_1 = 0; params$Vmax_Liver_2 = 0; params$Vmax_Liver_3 = 0; params$Vmax_Liver_4 = 0;
    params$Vmax_Lung_0 = 0; params$Vmax_Lung_1 = 0; params$Vmax_Lung_2 = 0; params$Vmax_Lung_3 = 0; params$Vmax_Lung_4 = 0;
    params$Vmax_Muscle_0 = 0; params$Vmax_Muscle_1 = 0; params$Vmax_Muscle_2 = 0; params$Vmax_Muscle_3 = 0; params$Vmax_Muscle_4 = 0;
    params$Vmax_Skin_0 = 0; params$Vmax_Skin_1 = 0; params$Vmax_Skin_2 = 0; params$Vmax_Skin_3 = 0; params$Vmax_Skin_4 = 0;
    params$Vmax_Marrow_0 = 0; params$Vmax_Marrow_1 = 0; params$Vmax_Marrow_2 = 0; params$Vmax_Marrow_3 = 0; params$Vmax_Marrow_4 = 0;
    
    params$Vmax_p_Adip_0 = 0; params$Vmax_p_Adip_1 = 0; params$Vmax_p_Adip_2 = 0; params$Vmax_p_Adip_3 = 0; params$Vmax_p_Adip_4 = 0;
    params$Vmax_p_Bone_0 = 0; params$Vmax_p_Bone_1 = 0; params$Vmax_p_Bone_2 = 0; params$Vmax_p_Bone_3 = 0; params$Vmax_p_Bone_4 = 0;
    params$Vmax_p_Brain_0 = 0; params$Vmax_p_Brain_1 = 0; params$Vmax_p_Brain_2 = 0; params$Vmax_p_Brain_3 = 0; params$Vmax_p_Brain_4 = 0;
    params$Vmax_p_Heart_0 = 0; params$Vmax_p_Heart_1 = 0; params$Vmax_p_Heart_2 = 0; params$Vmax_p_Heart_3 = 0; params$Vmax_p_Heart_4 = 0;
    params$Vmax_p_Kidney_0 = 0; params$Vmax_p_Kidney_1 = 0; params$Vmax_p_Kidney_2 = 0; params$Vmax_p_Kidney_3 = 0; params$Vmax_p_Kidney_4 = 0;
    params$Vmax_p_Intestine_0 = 0; params$Vmax_p_Intestine_1 = 0; params$Vmax_p_Intestine_2 = 0; params$Vmax_p_Intestine_3 = 0; params$Vmax_p_Intestine_4 = 0;
    params$Vmax_p_Liver_1 = 0; params$Vmax_p_Liver_2 = 0; params$Vmax_p_Liver_3 = 0; params$Vmax_p_Liver_4 = 0;
    params$Vmax_p_Lung_0 = 0; params$Vmax_p_Lung_1 = 0; params$Vmax_p_Lung_2 = 0; params$Vmax_p_Lung_3 = 0; params$Vmax_p_Lung_4 = 0;
    params$Vmax_p_Muscle_0 = 0; params$Vmax_p_Muscle_1 = 0; params$Vmax_p_Muscle_2 = 0; params$Vmax_p_Muscle_3 = 0; params$Vmax_p_Muscle_4 = 0;
    params$Vmax_p_Skin_0 = 0; params$Vmax_p_Skin_1 = 0; params$Vmax_p_Skin_2 = 0; params$Vmax_p_Skin_3 = 0; params$Vmax_p_Skin_4 = 0;
    params$Vmax_p_Marrow_0 = 0; params$Vmax_p_Marrow_1 = 0; params$Vmax_p_Marrow_2 = 0; params$Vmax_p_Marrow_3 = 0; params$Vmax_p_Marrow_4 = 0;
    
    params$Km_Adip_0 = 1; params$Km_Adip_1 = 1; params$Km_Adip_2 = 1; params$Km_Adip_3 = 1; params$Km_Adip_4 = 1;
    params$Km_Bone_0 = 1; params$Km_Bone_1 = 1; params$Km_Bone_2 = 1; params$Km_Bone_3 = 1; params$Km_Bone_4 = 1;
    params$Km_Brain_0 = 1; params$Km_Brain_1 = 1; params$Km_Brain_2 = 1; params$Km_Brain_3 = 1; params$Km_Brain_4 = 1;
    params$Km_Heart_0 = 1; params$Km_Heart_1 = 1; params$Km_Heart_2 = 1; params$Km_Heart_3 = 1; params$Km_Heart_4 = 1;
    params$Km_Kidney_0 = 1; params$Km_Kidney_1 = 1; params$Km_Kidney_2 = 1; params$Km_Kidney_3 = 1; params$Km_Kidney_4 = 1;
    params$Km_Intestine_0 = 1; params$Km_Intestine_1 = 1; params$Km_Intestine_2 = 1; params$Km_Intestine_3 = 1; params$Km_Intestine_4 = 1;
    params$Km_Liver_1 = 1; params$Km_Liver_2 = 1; params$Km_Liver_3 = 1; params$Km_Liver_4 = 1;
    params$Km_Lung_0 = 1; params$Km_Lung_1 = 1; params$Km_Lung_2 = 1; params$Km_Lung_3 = 1; params$Km_Lung_4 = 1;
    params$Km_Muscle_0 = 1; params$Km_Muscle_1 = 1; params$Km_Muscle_2 = 1; params$Km_Muscle_3 = 1; params$Km_Muscle_4 = 1;
    params$Km_Skin_0 = 1; params$Km_Skin_1 = 1; params$Km_Skin_2 = 1; params$Km_Skin_3 = 1; params$Km_Skin_4 = 1;
    params$Km_Marrow_0 = 1; params$Km_Marrow_1 = 1; params$Km_Marrow_2 = 1; params$Km_Marrow_3 = 1; params$Km_Marrow_4 = 1
    
    params$Vmax_Liver_0 = Vmax_Liver_0
    params$Vmax_p_Liver_0 = Vmax_p_Liver_0
    params$Km_Liver_0 = Km_Liver_0
...
predicted.feats <- c(
  ...
  "M_Brain_0", "M_Brain_1",
  "M_Heart_0", "M_Heart_1",
  "M_Kidney_0", "M_Kidney_1",
  "M_Intestine_0", "M_Intestine_1",
  "M_Liver_0", "M_Liver_1",
  "Cinh_0", "M_Lung_0", "M_Lung_1",
  "M_Muscle_0", "M_Muscle_1",
  "M_Skin_0", "M_Skin_1",
  "DeposRate",
  "StratCornAdd", "StratCornDecr", "EvapReal", "EvapSC", "Sum_Skin_Air", "Sum_Skin_Liq",
  "M_Marrow_0", "M_Marrow_1",
  "M_LungArt_0", "M_LungArt_1",
  "M_LungVen_0", "M_LungVen_1",
  "UrinExcr_0", "UrinExcr_1",
  "M_inhaled_0",
  "Μ_Exh_0", "Μ_Exh_1",
  "M_IntCav_0", "M_IntCav_1",
  "BolusDose",
  "MassSurf", "StratCorn",
  "UrinVol",
  "Sum_Bolus",
  ...
  "C_Brain_0", "C_Brain_1",
  "C_Heart_0", "C_Heart_1",
  "C_Kidney_0", "C_Kidney_1",
  "C_Intestine_0", "C_Intestine_1",
  "C_Liver_0", "C_Liver_1",
  "C_Lung_0", "C_Lung_1",
  "C_Muscle_0", "C_Muscle_1",
  "C_Skin_0", "C_Skin_1",
  "C_Marrow_0", "C_Marrow_1",
  
  "C_BlungVen_0", "C_BlungVen_1",
  "C_BlungArt_0", "C_BlungArt_1",
  "Cblart_0", "Cblart_1",
  "Cblven_0", "Cblven_1",
